...
@section('content-header')
    <div class="container-fluid">
        <div class="row mb-2">
            <div class="col-sm-6">
                <h1 class="m-0 text-dark">Добавить атрибут</h1>
            </div><!-- /.col -->
            <div class="col-sm-6">
            ...
            <div class="col-12">
                <div class="card">
                    <div class="card-header">
                        <h3 class="card-title">Добавить новый атрибут:</h3>
                    </div>
                    <div class="card-body">
                            ...
                            <div class="row">
                                <div class="col-sm-4">
                                    ...
                                    <div class="form-group">
                                        <label>Code</label>
                                        <input type="text" class="form-control" name="code" placeholder="Введите индификатор атрибута">
                                    </div>
                                    @error('code')
